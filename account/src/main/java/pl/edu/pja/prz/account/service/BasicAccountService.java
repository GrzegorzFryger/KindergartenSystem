...
public abstract class BasicAccountService<T extends BasicAccountRepository<E>, E extends Account> {
	...
	public BasicAccountService(T accountRepository, PasswordManager passwordManager, AccountFactory accountFactory,
