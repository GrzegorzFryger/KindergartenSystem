...
@Component
public class AdministratorAccountFactory extends StandardAccountFactory implements AccountAdministratorFactory{

	private final PrivilegeType ADMIN_PRIVILEGE = PrivilegeType.ADMINISTRATOR;

	public AdministratorAccountFactory() {
	}
	...
	public Employee createAdministratorAccount(Address address, FullName fullName,
	                                           Phone phone, Password password, String email) {
		return createAdministrator(address, fullName, phone, password, email);
	}
