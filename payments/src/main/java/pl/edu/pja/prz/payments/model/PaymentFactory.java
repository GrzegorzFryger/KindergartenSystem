...
public class PaymentFactory {
	public static final Status STATUS = Status.NONACTIVE;
	...
	public static RecurringPayment createOtherReccuringPayment(Child child, Payment payment, PeriodValidity periodValidity) {
